...
import { useRegisterMutation, useSendCodeMutation } from "../../slices/usersApiSlice";
...
const RegisterScreen = () => {
  ...
  const verfiyCode = async () => {
    if (parseInt(OTPinput) === otpCode) {
      ...
      toast.error(
        "The code is not incorrect, try again or re-send the code"
      );
    }
  };
  return (
        ...
        <Col md={8}>
          {(!showOTPinput) ? (
            <FormContainer className="register-content mt-4">
              ...
              <p className="white">Sign Up to continue to Medi<span style={{color:"#75dab4"}}>Q</span>uest</p>
           ...
           (
            ...
            <Col md={8} className="mx-auto mt-5">
              ...
              {LoadingOTP && <Spinner
                      ...
                      ></Spinner>}
              <Form >
                <Form.Group className="my-2 white mt-3 mb-2" controlId="otp-input">
                  <Form.Control
                    className="inputs"
                    type="name"
